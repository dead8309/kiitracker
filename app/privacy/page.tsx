    ...
    <div className="container flex flex-col items-center mt-10">
      ...
      <div className="mt-4 w-full sm:w-2/3">
        <p className="text-lg">
          ...
          with third parties. Additionally, we may collect non-personal
          ...
          responsibility for the privacy practices of these third parties. We
          reserve the right to update our Privacy Policy at any time, and any
          changes will be communicated by posting the new Privacy Policy on this
          page. It is recommended to review this policy periodically for
          updates. If you have any questions or concerns about our Privacy
          Policy, please contact us at <strong>deadyt8309@gmail.com</strong>.
        </p>
      </div>
    </div>
  )
